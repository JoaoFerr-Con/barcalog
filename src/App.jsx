...
const ITENS_NAV = [{
  ...
  descricao: "Criação e gerenciamento de janelas de agendamento — módulo em desenvolvimento, depende de backend próprio."
}, {
  chave: "portaria",
  rotulo: "Portaria",
  icone: "door_front",
  ...
  chave: "mapa",
  rotulo: "Mapa de Negativação",
  icone: "map",
  descricao: "Mapa simulado de Barcarena com as ocorrências de negativação (N1/N2/N3) por zona — módulo em desenvolvimento, aguardando GPS por carreta."
}, {
  chave: "carretas",
  rotulo: "Carretas",
...
const TITULOS_PAGINA = {
  ...
  "mapa": {
    titulo: "Mapa de Negativação",
    sub: "Ocorrências N1/N2/N3 por zona — módulo em desenvolvimento (simulado)"
  },
  "frotas": {
    titulo: "Cadastros",
  ...
  "agendamentos": {
    titulo: "Agendamentos",
    sub: "Módulo em desenvolvimento — depende de backend próprio"
  },
  "configuracoes": {
