...
import GuiaNavegacao from "./components/GuiaNavegacao.jsx";
...
import { buscarVeiculoPorPlaca, atualizarStatusPortaria } from "./data/negativacaoStore.js";
...
function EstruturaBase({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, guiaAberto && /*#__PURE__*/React.createElement(GuiaNavegacao, {
    itens: ITENS_NAV,
    ...
    style: { width: "100%", justifyContent: "flex-start", gap: 8, marginBottom: 8 },
    onClick: () => setGuiaAberto(true)
  }, /*#__PURE__*/React.createElement("span", {
    className: "material-symbols-outlined",
    style: { fontSize: 18 }
  }, "help"), "Guia de navegação"), /*#__PURE__*/React.createElement("button", {
    className: "botao botao--fantasma",
    style: { width: "100%", justifyContent: "flex-start", gap: 8, marginBottom: 12, borderStyle: "dashed" },
    onClick: aoAbrirPortal
  }, /*#__PURE__*/React.createElement("span", {
    className: "material-symbols-outlined",
    style: { fontSize: 18 }
  }, "open_in_new"), "Portal do Transportador"), /*#__PURE__*/React.createElement("button", {
