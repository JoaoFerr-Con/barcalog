...
const SEED = {
  ...
  contestacoes: [],
  veiculos: [
    { id: "v1", placa: "ENM-1001", transportadora: "Rota Amazônia Cargas", modelo: "Carreta graneleira" },
    { id: "v2", placa: "NGL-3021", transportadora: "Norte Grãos Logística", modelo: "Carreta graneleira" }
  ],
  condutores: [
...
export function cadastrarVeiculo({ placa, transportadora, modelo }) {
  const veiculo = { id: `v${Date.now()}`, placa, transportadora, modelo };
