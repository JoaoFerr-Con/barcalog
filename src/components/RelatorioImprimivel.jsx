    ...
    <div className="relatorio-imprimir">
      {/* ==================== CABEÇALHO + METODOLOGIA ==================== */}
        ...
        <div className="ri-secao" style={{ marginBottom: 8 }}>
          <h2><span className="ri-barra" />Metodologia, Fonte de Dados e Rastreabilidade</h2>
          <div style={{ display: "flex", gap: 12, fontSize: 9, color: "#475569" }}>
            <div style={{ flex: 1 }}>
              <p className="ri-texto"><b>Base de dados:</b> Registros reais de marcação e liberação de veículos nos terminais portuários de Barcarena/PA, extraídos dos sistemas operacionais dos terminais Unitapajós, TGPM e Hidrovias do Brasil. Os dados foram exportados em formato .xlsx (planilhas M8) e convertidos para o formato JSON do BarcaLog sem alteração de conteúdo.</p>
              <p className="ri-texto"><b>Período analisado:</b> 29/Dez/2025 a 31/Jul/2026 ({kpis.diasOperados} dias com pelo menos uma marcação registrada).</p>
              <p className="ri-texto"><b>Amostra:</b> {kpis.total.toLocaleString("pt-BR")} movimentos de carga (marcação → liberação), representando a totalidade dos registros disponíveis no período — nenhum registro foi excluído ou filtrado.</p>
              <p className="ri-texto"><b>Campos utilizados por registro:</b> COD_MOVIMENTO (id), SENHA, CONVENIO, COD_CONVENIO, CICLO, DATA_MARCACAO, HORA_MARCACAO, DATA_LIBERACAO, HORA_LIBERACAO. O campo "esperaHoras" é calculado: (Data/Hora Liberação − Data/Hora Marcação) em horas.</p>
            </div>
            <div style={{ flex: 1 }}>
              <p className="ri-texto"><b>Métricas derivadas:</b> Tempo de permanência (Tp), janelas de operação (D0–D3), taxa de chegada/liberação por hora, custo de retenção (base ANTT: R$600/dia/veículo), fator de utilização (ρ = λ/μ) e projeções de tendência por regressão linear simples (mínimos quadrados).</p>
              <p className="ri-texto"><b>Limitações conhecidas:</b> (1) O dataset não contém timestamps por etapa interna (triagem, pesagem, tombador) — a decomposição por etapa na seção 12 é estimada proporcionalmente com base em referências do setor. (2) Projeções de saturação assumem continuidade linear da tendência recente e não modelam sazonalidade de safra. (3) O custo de retenção é estimativo (R$600/dia, referência ANTT) e pode variar conforme contrato e tipo de carga.</p>
              <p className="ri-texto"><b>Verificação de integridade:</b> Todos os {kpis.total.toLocaleString("pt-BR")} registros foram validados: zero campos obrigatórios faltando, zero datas inválidas, zero inconsistências entre datas e tempo de espera calculado. Os totais mensais do Unitapajós foram cruzados com o relatório de referência fornecido pelo terminal e batem em 100%.</p>
            </div>
          </div>
        </div>

        <div className="ri-secao" style={{ marginBottom: 8 }}>
          <h2><span className="ri-barra" />Composição da Base de Dados por Terminal</h2>
          <p className="ri-texto">Detalhamento do volume, cobertura temporal e perfil operacional de cada terminal que compõe este relatório.</p>
          <table className="ri-tabela" style={{ fontSize: 8.5 }}>
            <thead>
              <tr><th>Terminal</th><th>Registros</th><th>Primeiro Dia</th><th>Último Dia</th><th>Dias Ativos</th><th>Espera Média</th><th>Retidos {'>'}24h</th><th>Estouro {'>'}144h</th><th>Convênios</th></tr>
            </thead>
            <tbody>
              <tr>
                <td><b>Unitapajós</b></td><td>35.843</td><td>01/01/2026</td><td>31/07/2026</td><td>208</td><td>10,25h</td><td>1.704 (4,8%)</td><td>1</td><td>7</td>
              </tr>
              <tr>
                <td><b>TGPM</b></td><td>36.487</td><td>31/12/2025</td><td>31/07/2026</td><td>212</td><td>11,62h</td><td>4.850 (13,3%)</td><td>1</td><td>2</td>
              </tr>
              <tr style={{ background: "#FEF3C7" }}>
                <td><b>Hidrovias</b></td><td>30.995</td><td>29/12/2025</td><td>30/07/2026</td><td>198</td><td style={{ color: "#DC2626", fontWeight: 700 }}>21,31h</td><td style={{ color: "#DC2626", fontWeight: 700 }}>9.808 (31,6%)</td><td>6</td><td>3</td>
              </tr>
              <tr className="ri-tabela__total">
                <td>CONSOLIDADO</td><td>103.325</td><td>29/12/2025</td><td>31/07/2026</td><td>214</td><td>14,05h</td><td>16.362 (15,8%)</td><td>8</td><td>—</td>
              </tr>
            </tbody>
          </table>
          <p className="ri-texto" style={{ marginTop: 6 }}>
            <b>Nota sobre Hidrovias:</b> o terminal apresenta espera média de 21,31h — 2,1× maior que o Unitapajós (10,25h) e 1,8× maior que o TGPM (11,62h). 
            Dos 8 veículos em estouro crítico ({'>'}144h) no período consolidado, 6 são da Hidrovias. 
            O volume menor (30.995 vs ~36.000 dos outros terminais) é consistente com o número de dias ativos (198 vs 208–212) e não indica perda de dados — 
            a Hidrovias começou a operar com volume expressivo a partir de fevereiro/2026, enquanto os outros dois já tinham operação relevante em janeiro.
            A taxa de retenção de 31,6% ({'>'}24h) é o achado operacional mais significativo deste relatório e merece investigação específica.
          </p>
        </div>
