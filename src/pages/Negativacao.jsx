...
function FormularioOcorrencia() {
  ...
  function enviar(e) {
    ...
    setForm({ nivel: "N1", placa: "", transportadora: "", descricao: "", local: "", responsavel: "Admin Teste", evidencias: [] });
  }
...
export default function Negativacao() {
  ...
  return (
    <>
      <AvisoDadosSimulados>
        As transportadoras, veículos e ocorrências de negativação abaixo são um cadastro de exemplo.
      </AvisoDadosSimulados>
