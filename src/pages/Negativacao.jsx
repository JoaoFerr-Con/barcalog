          ...
          <div className="cartao">
            ...
            <div className="cartao__corpo">
              {transportadoras.map(t => (
                <div key={t.id} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 0", borderBottom: "1px solid var(--superficie-alt)" }}>
                  <div>
              ...
              {contestacoesPendentes.map(c => (
                <div key={c.id} style={{ padding: "10px 0", borderBottom: "1px solid var(--superficie-alt)" }}>
                  ...
                  <div style={{ display: "flex", gap: 8, marginTop: 8 }}>
                    <button className="botao botao--primario" onClick={() => responderContestacao(c.id, true, "Documentação conferida, negativação retirada.")}>Aprovar</button>
                    <button className="botao" onClick={() => responderContestacao(c.id, false, "Documentação insuficiente.")}>Rejeitar</button>
                  </div>
                </div>
              ))}
            </div>
