  ...
  return (
    <>
      <div className="cartao" style={{ marginBottom: 16 }}>
        <div className="cartao__cabecalho"><h3>Próximas 6 Horas (a partir de agora)</h3><p>Risco de fila, com base em quanto historicamente entra x quanto sai nessa faixa de horário</p></div>
        <div className="cartao__corpo">
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
            {proximas6h.map((h, i) => {
              const c = CORES_NIVEL[h.nivel];
              const excesso = Math.round((h.rho - 1) * 100);
              const legenda = excesso > 0 ? `${excesso}% mais chegando que saindo` : "fluxo normal";
              return (
                <div key={i} style={{ flex: "1 1 140px", padding: "12px 14px", borderRadius: 12, background: c.bg, textAlign: "center" }}>
                  ...
                  <div style={{ fontSize: 10, color: "var(--tinta-fraca)", marginTop: 2 }}>{legenda}</div>
                </div>
              );
            })}
          </div>
      ...
      <div className="grade-painel conteudo-pagina">
        <div className="pilha">
          ...
          <div className="cartao">
            <div className="cartao__cabecalho"><h3>Concentração de Tráfego por Turno</h3><p>Percentual de retenção por faixa horária — histórico completo</p></div>
            <div className="cartao__corpo">
              <p style={{ fontSize: 11, color: "var(--tinta-fraca)", marginBottom: 10 }}>
                <b>Retenção</b> = carreta que entrou nessa faixa de horário e ficou mais de 24h no terminal até ser liberada.
              </p>
          ...
          <div className="cartao">
            <div className="cartao__cabecalho"><h3>Horários Mais Críticos</h3><p>Combinações dia da semana × turno com mais carretas retidas por mais de 24h</p></div>
            <div className="cartao__corpo">
              <table style={{ fontSize: 12 }}>
