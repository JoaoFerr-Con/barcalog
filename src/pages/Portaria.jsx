        ...
        <div className="cartao__corpo" style={{ maxWidth: 760, margin: "0 auto", paddingTop: 24 }}>
          ...
          {resultado && (
            <>
              ...
              <div style={{
                display: "flex", alignItems: "center", justifyContent: "center", gap: 24, padding: "32px 24px",
                border: "1px dashed var(--borda)", borderRadius: 12, background: "#fff"
              }}>
                <QRCodeSVG value={resultado.placa} size={140} />
                <div style={{ fontSize: 12.5, color: "var(--tinta-suave)", maxWidth: 280 }}>
                  <b>Demonstração do conceito.</b> Esse QR codifica a placa <b>{resultado.placa}</b> — a leitura na portaria
                  recupera o veículo direto, sem digitação, e é o gatilho que atualiza o status de entrada/saída.
                  Quando o módulo de Agendamentos existir com backend próprio, o QR passa a codificar o número do agendamento, não a placa.
                </div>
              </div>
            </>
          )}
