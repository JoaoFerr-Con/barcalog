              ...
              <tbody>
                {veiculos.map(v => (
                  <tr key={v.id}>
                    ...
                    <td>{v.modelo}</td>
                    <td><button className="botao botao--fantasma" onClick={() => removerVeiculo(v.id)}>Remover</button></td>
                  </tr>
                ))}
              </tbody>
            </table>
              ...
              <tbody>
                {condutores.map(c => (
                  <tr key={c.id}>
                    ...
                    <td><button className="botao botao--fantasma" onClick={() => removerCondutor(c.id)}>Remover</button></td>
                  </tr>
                ))}
              </tbody>
            </table>
