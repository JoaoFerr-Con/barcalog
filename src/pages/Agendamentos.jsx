...
const SEED_AGENDAMENTOS = [
  { id: "AGD-004821", hora: "08:00", placa: "ENM-1001", transportadora: "Rota Amazônia Cargas", terminal: "unitapajos", carga: "Milho", motorista: "Elias Farias", janela: "D0", status: "Finalizado" },
  { id: "AGD-004822", hora: "09:00", placa: "NGL-3021", transportadora: "Norte Grãos Logística", terminal: "unitapajos", carga: "Soja", motorista: "José Ribeiro", janela: "D1", status: "Em operação" },
  { id: "AGD-004823", hora: "10:00", placa: "ATS-4410", transportadora: "AgroTransportes Sul", terminal: "tgpm", carga: "Soja", motorista: "Marcos Andrade", janela: "D0", status: "Aguardando entrada" },
  { id: "AGD-004824", hora: "10:00", placa: "RAC-5502", transportadora: "Rota Amazônia Cargas", terminal: "tgpm", carga: "Milho", motorista: "Paulo Souza", janela: "D0", status: "Confirmado" },
  { id: "AGD-004825", hora: "11:00", placa: "BCT-7715", transportadora: "Barcarena Transportes", terminal: "hidrovias", carga: "Soja Segregado", motorista: "Carla Lima", janela: "D2", status: "A caminho" },
  { id: "AGD-004826", hora: "11:00", placa: "TNC-2290", transportadora: "TransNorte Cargas", terminal: "hidrovias", carga: "Caçamba", motorista: "Rui Nogueira", janela: "D3", status: "Atrasado" },
  { id: "AGD-004827", hora: "12:00", placa: "ATS-9091", transportadora: "AgroTransportes Sul", terminal: "unitapajos", carga: "Soja", motorista: "Fábio Melo", janela: "D0", status: "Agendado" }
];
...
export default function Agendamentos() {
  ...
  const [form, setForm] = useState({ hora: "", placa: "", transportadora: "", terminal: "unitapajos", carga: "Soja", motorista: "", janela: "D0" });
  ...
  function criarAgendamento(e) {
    ...
    setForm({ hora: "", placa: "", transportadora: "", terminal: "unitapajos", carga: "Soja", motorista: "", janela: "D0" });
    setFormAberto(false);
    ...
    <>
      ...
      <div className="cartao">
        ...
        {formAberto && (
          <div className="cartao__corpo" style={{ borderBottom: "1px solid var(--superficie-alt)" }}>
            <p style={{ fontSize: 11.5, color: "var(--tinta-suave)", marginBottom: 12 }}>
              <b>Janela de Conformidade</b> é o compromisso de SLA assumido no agendamento — em quanto tempo, depois da entrada, a carreta deve ser liberada (D0 até 24h, D1 até 48h, e assim por diante). É o mesmo critério usado no relatório de permanência.
            </p>
            <form onSubmit={criarAgendamento} style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
              ...
              <label style={{ fontSize: 12, fontWeight: 600 }}>
                ...
                <select value={form.janela} onChange={e => setForm(f => ({ ...f, janela: e.target.value }))} style={{ display: "block", width: "100%", marginTop: 4, padding: 8, borderRadius: 8, border: "1px solid var(--borda)" }}>
        ...
        <div className="cartao__corpo" style={{ overflowX: "auto" }}>
          <table>
            <thead><tr><th>Horário</th><th>Placa</th><th>Transportadora</th><th>Terminal</th><th>Carga</th><th>Janela</th><th>Status</th><th></th></tr></thead>
            <tbody>
              {filtrados.map(a => {
                const c = CORES_STATUS[a.status];
                const j = janelaInfo(a.janela);
                return (
                  <tr key={a.id}>
